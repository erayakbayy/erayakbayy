# Hi there, I'm Eray Akbay 👋

### Full-Stack Developer & Automation Specialist

Yüksek performanslı web uygulamaları, modern arayüzler ve otomasyon sistemleri geliştiren bir yazılımcıyım. Kullanıcı deneyimini ön planda tutan, ölçeklenebilir ve güvenli ürün mimarilerine odaklanıyorum.
...
**Languages & Core:**  
`JavaScript (ES6+)` · `TypeScript` · `HTML5` · `CSS3` · `Python` · `Node.js`
...
**Desktop & Automation:**  
`Python` · `Google Apps Script` · `REST APIs` · `Postman` · `Git` · `GitHub`
...
- **Stack (high-level):** Python core · embedded web UI · release integrity.

#### Automated Barcode & Operations Tool
> **Depo / stok eşleştirme otomasyonu**
- Barkod işleme, stok takibi ve operasyonel eşleştirmeyi otomatize eden özel çözüm.
- Operasyonel hata oranını düşüren Google Apps Script + Node.js entegrasyonu.
